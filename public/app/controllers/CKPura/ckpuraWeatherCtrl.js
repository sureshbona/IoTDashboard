...
angular.module('ckpuraWeatherCtrl', ['angularUtils.directives.dirPagination', 'ckpuraWeatherService'])

    .controller('ckpuraWeatherController', function(ckpuraWeather, $scope, $http) {
